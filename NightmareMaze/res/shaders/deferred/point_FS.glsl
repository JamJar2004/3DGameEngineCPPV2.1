...
void main()
{
	...
	vec4  diffuseLightColor = (lightColor *  diffuseFactor) / attenuation;
	vec4 specularLightColor = (lightColor * specularFactor) / attenuation;
	
	o_color = texColor * diffuseLightColor + specularLightColor;
}