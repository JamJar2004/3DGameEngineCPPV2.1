...
namespace GL
{
	...
	{
		AttachmentInfo(InternalImageFormat internalFormat, ImageFormat format, ElementType elementType, MinFilterMode minFilter, MagFilterMode magFilter, TextureWrappingMode wrappingMode) :
			InternalFormat(internalFormat), Format(format), PixelElementType(elementType), MinFilter(minFilter), MagFilter(magFilter), WrappingMode(wrappingMode) {}

		InternalImageFormat InternalFormat;
		ImageFormat         Format;
		ElementType         PixelElementType;
	...
	public:
		...
		TextureAttachment(uint32_t width, uint32_t height, size_t index, InternalImageFormat internalFormat, ImageFormat format, ElementType elementType, MinFilterMode minFilter, MagFilterMode magFilter, TextureWrappingMode wrappingMode);
