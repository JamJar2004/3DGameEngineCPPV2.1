...
namespace GL
{
	...
	Texture2D::Texture2D(uint32_t width, uint32_t height, const void* pixelData, InternalFormat internalFormat, Format format, ElementType elementType, MinFilterMode minFilter, MagFilterMode magFilter, WrappingMode wrappingMode) :
	...
	TextureCube::TextureCube(uint32_t width, uint32_t height, uint32_t channelCount, const void* facesPixelData, InternalFormat internalFormat, Format format, ElementType elementType, MinFilterMode minFilter, MagFilterMode magFilter, WrappingMode wrappingMode) :
		Texture(width, height)
	{
