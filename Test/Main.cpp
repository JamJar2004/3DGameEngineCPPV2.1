...
public:
	...
	virtual Camera OnStart(KeyboardDevice& keyboard, MouseDevice& mouse) override
	{
		...
		Camera result = CreateCamera(Transformation(glm::vec3(0, 2, 3)), Projection(70.0f, GraphicsMode().GetAspectRatio(), 0.1f, 1000.0f));
...
GameSettings Game::StartSettings()
{
	...
	return GameSettings(GraphicsMode(800, 600), "3D Game Engine Test", startScene, 5000.0f);
}
